...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-brandGold-800 via-brandBlue-700 to-brandGreen-600 text-white relative overflow-hidden border-t border-white/10">
      {/* Decorative elements */}
      ...
      <div className="container py-12 md:py-16 lg:py-20 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 pb-8 sm:pb-12 border-b border-white/20">
          {/* Brand Section */}
          <div className="col-span-1 sm:col-span-2 md:col-span-2">
            ...
            <p className="mb-6 text-brandCream-50 text-base sm:text-lg leading-relaxed font-normal">
          ...
          {/* Quick Links */}
          <div>
            <h5 className="font-bold mb-6 text-xl tracking-wide text-brandGold-100 drop-shadow-lg">Quick Links</h5>
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-brandCream-50 hover:text-brandGold-300 transition-all duration-300 inline-flex items-center group font-medium">
                  <span className="w-2 h-2 bg-brandGold-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 mr-3"></span>
                  Home
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-brandCream-50 hover:text-brandGold-300 transition-all duration-300 inline-flex items-center group font-medium">
                  <span className="w-2 h-2 bg-brandGold-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 mr-3"></span>
                  Services
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-brandCream-50 hover:text-brandGold-300 transition-all duration-300 inline-flex items-center group font-medium">
                  <span className="w-2 h-2 bg-brandGold-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 mr-3"></span>
                  About
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-brandCream-50 hover:text-brandGold-300 transition-all duration-300 inline-flex items-center group font-medium">
                  <span className="w-2 h-2 bg-brandGold-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 mr-3"></span>
                  Contact
                </Link>
              </li>
          ...
          {/* Legal & Support */}
          <div>
            <h5 className="font-bold mb-6 text-xl tracking-wide text-brandGold-100 drop-shadow-lg">Legal & Support</h5>
            <ul className="space-y-3">
              <li>
                <Link to="/terms" className="text-brandCream-50 hover:text-brandGold-300 transition-all duration-300 inline-flex items-center group font-medium">
                  <span className="w-2 h-2 bg-brandGold-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 mr-3"></span>
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-brandCream-50 hover:text-brandGold-300 transition-all duration-300 inline-flex items-center group font-medium">
                  <span className="w-2 h-2 bg-brandGold-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 mr-3"></span>
                  Privacy Policy
                </Link>
              </li>
              <li>
                <a href="mailto:info@tippingbridge.com" className="text-brandCream-50 hover:text-brandGold-300 transition-all duration-300 inline-flex items-center group font-medium">
                  <span className="w-2 h-2 bg-brandGold-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 mr-3"></span>
                  info@tippingbridge.com
                </a>
              </li>
              <li>
                <a href="tel:+9173036676000" className="text-brandCream-50 hover:text-brandGold-300 transition-all duration-300 inline-flex items-center group font-medium">
                  <span className="w-2 h-2 bg-brandGold-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 mr-3"></span>
                  +91 73036676000
                </a>
              </li>
        ...
        {/* Bottom Section */}
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 border-t border-white/20">
          <p className="text-sm text-brandCream-50 font-normal">
            &copy; {new Date().getFullYear()} Tipping Bridge. All rights reserved.
          </p>
          <p className="text-sm text-brandCream-50 font-normal flex items-center gap-2">
